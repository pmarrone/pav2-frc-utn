...
{
    string strcon = ConfigurationManager.ConnectionStrings["PAVII"].ConnectionString;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // Trace.IsEnabled = true;
        ...
        gv1.DataSource = Datos.DAOClientes.ObtenerTodos(strcon, "nombre");
  ...
  //          txtNombre.Text = "";
    ...
    protected void butEliminar_Click(object sender, EventArgs e)
    {
        ...
        MostrarListaDeClientes();
        Session["Clientes"] = Clientes;
        int id = (int)gv1.SelectedDataKey[0];
        DAOClientes.Eliminar(strcon, id);
    }
